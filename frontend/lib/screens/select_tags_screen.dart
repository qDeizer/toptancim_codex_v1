...
class _SelectTagsScreenState extends State<SelectTagsScreen> {
  ...
  bool _isInitialDataLoaded =
      false; // YENİ: Verinin ilk kez yüklendiğini takip eden bayrak
  ...
  Future<void> _saveSelection() async {
    ...
    try {
      await Provider.of<ConnectionProvider>(context, listen: false)
          .syncTagsForConnection(
              widget.connection.relationId, _selectedTagIds.toList());
          ...
          : FutureBuilder(
              ...
              builder: (ctx, snapshot) {
                ...
                if (!_isInitialDataLoaded) {
                  _selectedTagIds = connectionProvider.assignedTags
                      .map((t) => t.tagId)
                      .toSet();
                ...
                if (tagProvider.tags.isEmpty) {
                  return const Center(
                      child: Text('Henüz hiç etiket oluşturulmamış.'));
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return CheckboxListTile(
                      title: Text(tag.name),
                      subtitle: tag.note != null && tag.note!.isNotEmpty
                          ? Text(tag.note!)
                          : null,
                      value: isSelected,
